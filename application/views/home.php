        ...
        <div class="col-md-12 no-pad">
          ...
          <div class="navbar-header nav_2">
           ...
           <div class="nav-search col-lg-5 col-md-12 no-padding pull-right">
            ...
            <div class="div-left">
              <input type="text" class="m_1 form-control  input-sm" name="userid"  required="" placeholder="Enter Profile ID">

            </div>  
            <div class="div-left">
              <input type="password" class="form-control input-sm" name="password" placeholder="Password" id="psw" maxlength="40" value="">
            ...
            <?php 
               if($this->session->flashdata('loginfail')){ ?>
                <span style="color:white;font-size:14px;text-align:center;margin-bottom:5px;margin-left:90px;;">Please enter valid username/password</span>
               <?php }
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xs-12 no-padding">
                               ...
                               <div class="col-md-6 no-pad">
                                ...
                                <div id = "mobileshow" style="display:none">
                                    ...
                                    <div class="clearfix"></div>
                                <div class="col-md-8 no-padding"><!--change made in colms-->
                                ...
                                <div class="col-md-4">
                                <button class="btn btn-sm btn-danger pull-right" type="submit" name="submit" id="submit">Register Free</button>
                                </div>
                                </div>
                        </form>
                        </div>
